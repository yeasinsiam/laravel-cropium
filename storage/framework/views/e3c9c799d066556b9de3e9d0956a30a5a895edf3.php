            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <form class="forms-sample" method="POST" action="<?php echo e(route('admin.users.store')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-light">Reset</a>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Programs\Laravel\softtechit\laravel-cropium\resources\views/pages/admin/user/create.blade.php ENDPATH**/ ?>