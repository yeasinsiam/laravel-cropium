            ...
            <div class="row">
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-6">
                    ...
                    <div class="contact-form">
                        <form action="<?php echo e(route('customer.register')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <br />
                        <span>Already have an account? <a href="<?php echo e(route('customer.login-page')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Programs\Laravel\softtechit\laravel-cropium\resources\views/pages/customer/register.blade.php ENDPATH**/ ?>