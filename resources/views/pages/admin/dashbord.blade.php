...
@section('contents')
    <div class="content-wrapper">
        <h1>Welcome to <a href="{{ route('home.index') }}" target="_blank">{{ env('APP_NAME') }} </a> Admin Panel </h1>
    </div>
    {{-- <div class="content-wrapper">
                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est quod cupiditate esse fuga
                                </p>
